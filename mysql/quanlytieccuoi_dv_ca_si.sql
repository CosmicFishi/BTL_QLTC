...
CREATE TABLE `dv_ca_si` (
  `MaHD` int NOT NULL,
  `ThongTinCaSi` varchar(45) COLLATE utf8_unicode_ci NOT NULL,
  `SoLuongBaiHat` int NOT NULL,
  `GiaDv` int NOT NULL,
  PRIMARY KEY (`MaHD`),
  KEY `fk_ca_si_hoa_don_idx` (`MaHD`),
  CONSTRAINT `fk_ca_si_hoa_don` FOREIGN KEY (`MaHD`) REFERENCES `hoa_don` (`MaHoaDon`)
